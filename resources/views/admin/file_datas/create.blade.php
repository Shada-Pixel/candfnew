                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="">
                        <a href="{{route('dashboard')}}">
                            <button class="font-mont px-2 py-2 bg-green-600 text-white font-semibold text-xs uppercase tracking-widest transition ease-in-out duration-150 " id="">Dashboard</button>
                        </a>
                        <a href="{{route('agents.create')}}">
                            <button class="font-mont px-2 py-2 bg-sky-600 text-white font-semibold text-xs uppercase tracking-widest transition ease-in-out duration-150 " id="">New Agent</button>
                        </a>
                        <a href="{{route('ie_datas.index')}}">
                            <button class="font-mont px-2 py-2 bg-indigo-600 text-white font-semibold text-xs uppercase tracking-widest transition ease-in-out duration-150 " id="">New Imp/Exp</button>
                        </a>
                    </div>
                </div>
