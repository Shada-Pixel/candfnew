        ...
        <div class="flex-grow">
            <div class="">
                <ul class="flex gap-2 font-medium">
                    <li class="">
                        <a href="#" class="card shadow-none rounded-b-none px-6 py-2 flex items-center text-blue-500"> <span> <i class="mdi mdi-swap-vertical mr-2 text-lg"></i>All</span></a>
                    </li>
                    <li class="">
            ...
            <div class="card rounded-tl-none">
                <div class="p-6">
                    ...
                    <h2 class="mb-4 text-xl">All Transaction</h2>
