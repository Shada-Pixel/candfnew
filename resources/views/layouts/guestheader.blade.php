    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex space-x-4 items-center">
                ...
                <a href="#" class="text-gray-800 hover:text-blue-500 px-3 py-2">About</a>

                <!-- Dropdown Container -->
                <div class="relative">
                    <button id="desktop-dropdown-button" class="text-gray-800 hover:text-blue-500 px-3 py-2 flex items-center">
                        Services
                    ...
                    <!-- Dropdown Menu -->
                    <div id="desktop-dropdown-menu" class="absolute hidden bg-white shadow-md rounded-lg mt-2 py-2 w-48">
                        <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-blue-50">Web Design</a>
                        <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-blue-50">SEO</a>
                        <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-blue-50">Marketing</a>
                    </div>
                </div>
