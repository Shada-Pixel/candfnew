        ...
        <div class="flex-grow">
            <div class="">
                <ul class="flex gap-2 font-medium">
                    ...
                    <li class="">
                        <a href="{{route('btransactions.deposit')}}" class="card shadow-none rounded-b-none px-6 py-2 flex items-center text-green-400" ><span><i class="mdi mdi-arrow-down mr-2 text-lg"></i>Deposits</span></a>
                    </li>
                    <li class="">
            ...
            <div class="card">
                <div class="p-6">
                    ...
                    <h2 class="mb-4 text-xl">Deposit Transaction</h2>
    ...
    <x-slot name="script">
        ...
        <script>
            ...
            var datatablelist = $('#transactionsTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('btransactions.deposit') !!}",
                columns: [{
