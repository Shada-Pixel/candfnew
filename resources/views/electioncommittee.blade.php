<x-guest-layout>
    ...
    {{-- Title --}}
    <x-slot name="title">Election Committee</x-slot>
        ...
        <section class="" id="">
            <div class="bg-gradient-to-r from-violet-400 to-purple-300 py-8">
                <div class="container mx-auto px-4">
                    <h1 class="text-3xl font-bold text-center text-gray-800">Election Committee</h1>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-6">
                        ...
                        @empty
                            ...
                            <div class="text-center col-span-2 sm:col-span-3">
                                <p class="text-gray-600">No election committee members found.</p>
                            </div>
